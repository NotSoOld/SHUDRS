...
namespace SHUDRS  {
	...
	[CustomEditor(typeof(StructConstruction))]
	[CanEditMultipleObjects]
	public class Editor_StructConstruction : Editor  {

		public StructConstruction construction;
		...
		public void OnEnable()  {
			...
			construction = (StructConstruction)target;
